...
def _load_resume_services():
    # Lazy import heavy NLP dependencies so app startup stays fast.
...
def extract_skills_only():
    ...
    content = file.read()
    extract_text, normalize_text, extract_skills, _, _, _ = _load_resume_services()
...
def analyze_resume():
    ...
    """
    extract_text, normalize_text, extract_skills, score_skills, generate_roadmap, map_courses_to_skills = _load_resume_services()
